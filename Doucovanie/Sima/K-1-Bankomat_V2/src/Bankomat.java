...
public class Bankomat {
    ...
    public void vypocitaj(double vstup) {
        ...
        System.out.println("Prajete si zvyšok(" + zvysok + "centov ) prenechať charite? (y/n) ");
        char c = sc.next().charAt(0);
        if(c == 'y' || c == 'Y') {
            vypisBankovky();
            System.out.println("Charite ste prenechali " + zvysok + "centov, ďakujeme že bojujete s nami a podporujete rakovinu Janáčkovi!" );
            System.out.println("===============================");
        } else if (c == 'n' || c == 'N') {
